...
function IndexPage() {
    ...
    return (
        <>
            <div className="relative w-full h-full pb-10 p-8">
                <div className="hidden md:block">
                    {/* <img className="absolute bg-cover bg-center w-full h-full inset-0" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/Hero%2008.png" /> */}
                </div>
